...
load('background-ai-openai-compatible.js');
...
(async () => {
  ...
  const aiRuntimeSource = fs.readFileSync(path.join(ROOT, 'background-ai-openai-compatible.js'), 'utf8');
  ...
  console.log('Desktop OpenAI-compatible AI contract tests passed');
})().catch(error => {
  console.error(error);
  process.exitCode = 1;
});
