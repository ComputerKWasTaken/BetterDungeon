...
function testWiring() {
  ...
  assert.ok(config.earlyScripts.includes('services/apollo-bridge.js'));
  assert.ok(config.scripts.includes('services/apollo-cache-service.js'));
}
