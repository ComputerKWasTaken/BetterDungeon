...
assert.match(feature, /labels = \{ automatic: 'Automatic', proposed: 'Approval', none: 'No changes' \}/);
assert.match(feature, /this\.changeModeBadge\.dataset\.mode = normalized/);
assert.match(feature, /automatic: \['Automatic', 'Apply edits now; approve deletions'\]/);
assert.match(feature, /proposed: \['Approval', 'Approve every change'\]/);
assert.match(feature, /none: \['No changes', 'Change tools disabled'\]/);
...
assert.match(styles, /\.bd-navigator-change-mode-badge\[data-mode="proposed"\]/);
assert.match(styles, /\.bd-navigator-change-mode-badge\[data-mode="none"\]/);
