...
(function () {
  ...
  const SECTIONS = Object.freeze({
    ...
    proposals: Object.freeze([
      ...
      '- BetterDungeon Routines are reusable instructions stored locally on this device. Each rule has an action interval and an Enabled toggle. Only enabled rules run automatically: after a newly completed AI Dungeon action crosses an absolute interval milestone, one run may be queued for that Routine in every adventure on this device. Opening an adventure, enabling a rule, reloading, editing, undoing, or restoring history does not fire a run or catch up missed milestones.',
