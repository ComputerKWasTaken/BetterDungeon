...
- **Ultrascripts AI** — Lets scripts call AI Dungeon's native Story Card generator for bounded sidecar reasoning without external API keys or visible story interruption.
