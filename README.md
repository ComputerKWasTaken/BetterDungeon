...
- **Navigator Routines** — Give Navigator instructions to run every N actions, or ask it in Chat to run a saved Routine now. Review each run in its own conversation. Six editable examples—from NPC Brains to Continuity Watch—start disabled. See [Routines](docs/NAVIGATOR_ROUTINES.md).
